...
class SalarioDadosComparativos():
    ...
    def validacao_colunas(entity, data, isInitial):
        ...
        if len(colunas) > 0 and checa_valor("Salario", data):
    ...
    def unifica_colunas(data):
        colunas = pegue_todas_colunas(['Salario', 'Area', "Curso", "Empresa", "Universidade", "Estado_Empresa", "Estado_Universidade", "Genero", 'Classe'], data)
