...
class IdadeDadosComparativos():
    ...
    def validacao_colunas(entity, data, isInitial):
        ...
        if len(colunas) > 0 and checa_valor("Idade", data):
    ...
    def unifica_colunas(data):
        colunas = pegue_todas_colunas(['Idade', 'Area', "Curso", "Empresa", "Universidade", "Estado_Empresa", "Estado_Universidade", "Genero", 'Classe'], data)
